            ...
            <tbody>
              <tr>
                <td className="product-thumbnail">
                  <a href="#">
                    <img src={require('./assets/images/images-product_img1.jpg')} alt="product1" />
                  </a>
                </td>
              ...
              <tr>
                <td className="product-thumbnail">
                  <a href="#">
                    <img src={require('./assets/images/images-product_img2.jpg')} alt="product2" />
                  </a>
                </td>
                <td className="product-name" data-title="Product">
              ...
              <tr>
                <td className="product-thumbnail">
                  <a href="#">
                    <img src={require('./assets/images/images-product_img3.jpg')} alt="product3" />
                  </a>
                </td>
                <td className="product-name" data-title="Product">
